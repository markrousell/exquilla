...
EwsNativeAttachment.prototype = {
  ...
  QueryInterface: XPCOMUtils.generateQI([Ci.msqIEwsNativeAttachment]),
  classInfo:       XPCOMUtils.generateCI({
                     classID: Components.ID("{78415047-8577-46B4-9CEC-6B9FB2B3580F}"),
                     classDescription: "ExQuilla native attachment",
                     contractID: "@mesquilla.com/ewsnativeattachment;1",
                     interfaces: [Ci.msqIEwsNativeAttachment],
                     flags: 0,
                   }),
