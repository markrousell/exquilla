...
exquilla.msgHVOoverlay = (function _msgHVOoverlay()
{
    ...
    CanDetachAttachments = function ewsCanDetachAttachments()
    {
      if (oldCanDetachAttachments())
      {
        ...
        if (gFolderDisplay.selectedMessage &&
            !safeGetInterface(gFolderDisplay.selectedMessage.folder, Ci.msqIEwsMailFolder))
          return true;
      }
      return false;
    }
  ...
  async function saveAllAttachments(attachments)
  {
      ...
      for (let attachment of attachments)
      {
        ...
        let ewsUrl;
        try {
          ewsUrl = url.QueryInterface(Ci.nsIInterfaceRequestor)
                      .getInterface(Ci.msqIEwsUrl);
        } catch (e) { }
        if (!(safeInstanceOf(ewsUrl, Ci.msqIEwsUrl)))
        {
